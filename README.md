...
- [Best LwM2M Agentic Skills](https://github.com/svdwalt007/Best-LwM2M-Agentic-Skills) `[2026-06]` - Agent skill for OMA LwM2M device management: all versions v1.0-v2.0, CoAP/DTLS/OSCORE stack, and 3GPP CIoT bindings (NB-IoT/LTE-M, non-IP, PSM/Queue Mode).
